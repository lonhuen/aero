...
plot \
'dat/${EXPNAME}.dat' using 1:(\$2/1000000) with linespoints ls 1 title 'Aero w',\
'dat/${EXPNAME}.dat' using 1:(\$3/1000000) with linespoints ls 2 title 'Aero wo',\
'dat/${EXPNAME}.dat' using 1:(\$4/1000000) with linespoints ls 3 title 'HoneyCrisp',\
" > plot.plt
gnuplot plot.plt
epspdf $EPS
rm $EPS
