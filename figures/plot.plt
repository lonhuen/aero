...
set style line 3 lc rgb 'black' dt 1 lt 1 lw 7 pt 4 pi -1 ps 3.0
plot 'dat/verifier_network_vs_fraction.dat' using 1:($2/1000000) with linespoints ls 1 title 'Aero','dat/verifier_network_vs_fraction.dat' using 1:($3/1000000) with linespoints ls 3 title 'Aero w/o RN-chk','dat/verifier_network_vs_fraction.dat' using 1:($4/1000000) with linespoints ls 2 title 'Baseline',
